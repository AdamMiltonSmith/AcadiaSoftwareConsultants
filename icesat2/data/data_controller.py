...
class data:
    ...
    def get_data(self):
        for i in range((end_date - start_date).days):
            current = "https://openaltimetry.org/data/api/icesat2/atl06?date="+ i +"&minx="+ minx +"&miny="+ miny +"&maxx="+ maxx +"&maxy="+ maxy +"&trackId=705&client=jupyter&outputFormat=csv"
            os.system('curl -X GET' + current + '-H' '"accept: */*" >>' + name)
